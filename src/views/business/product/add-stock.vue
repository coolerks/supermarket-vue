<template>
    <div id="addStocks">
        ...
        <el-breadcrumb separator="/" style="padding-left:10px;padding-bottom:10px;font-size:12px;">
            ...
            <el-breadcrumb-item :to="{ path: '/business/product/in-stocks' }">商品入库</el-breadcrumb-item>
                ...
                <div class="grid-content bg-purple">
                    <el-card>
                        ...
                        >
                            ...
                            <el-form-item v-if="existence==1" label="商品来源" prop="supplierId">
            ...
            <el-col :span="13">
                <div class="grid-content bg-purple-light">
                    <el-card>
                        ...
                        <el-alert
                                title="勾选先下方商品后,在左侧表单的明细中添加其入库数量"
                                type="info"
                            ...
                            <el-table-column prop="imageUrl" label="图片" align="center" width="150px" padding="0px">
                                ...
                                <template slot-scope="scope">
                                    <el-popover placement="right"  trigger="hover">
                                        ...
                                        <img  slot="reference" :src="scope.row.imageUrl" :alt="scope.row.imgUrl" style="height: 32px;width: 32px;cursor: pointer">
                                    </el-popover>
                                </template>
                            </el-table-column>
    ...
    export default {
        data() {
            ...
            return {
                ...
                addRules: {
                    supplierId: [
                        { required: true, message: "请选中商品来源", trigger: "blur" }
                    ],
                ...
                this.$refs.addRuleFormRef.validate(async valid => {
                    if (!valid) {
                        ...
                        if (res === "confirm") {
                            ...
                            if (res.success) {
                                this.$message.warning("商品入库进入审核状态");
