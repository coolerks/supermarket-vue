    ...
    <el-card class="box-card">
      ...
      <template>
        ...
        >
          ...
          <el-table-column prop="pnum" :show-overflow-tooltip='true' label="商品编号"></el-table-column>
  ...
  methods: {
    ...
    async publish(id) {
      ...
      if (!res.success) {
        ...
        return this.$message.success("商品已审核通过");
      }
    },
    /**
     * 删除商品
      ...
      this.$refs.editRuleFormRef.validate(async valid => {
        if (!valid) {
          ...
          if (res.success) {
            ...
            this.$message.error("商品信息更新失败:" + res.data.errorMsg);
          }
    ...
    async edit(id) {
      ...
      if (res.success) {
        ...
        return this.$message.error("商品信息编辑失败" + res.data.errorMsg);
      }
      const array = [];
      ...
      this.$refs.addRuleFormRef.validate(async valid => {
        if (!valid) {
          ...
          if (res.success) {
            ...
            return this.$message.error("商品添加失败:" + res.data.errorMsg);
          }
