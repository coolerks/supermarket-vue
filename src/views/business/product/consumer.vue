<template>
  <div id="productCategroys">
    ...
    <el-breadcrumb separator="/" style="padding-left:10px;padding-bottom:10px;font-size:12px;">
      ...
      <el-breadcrumb-item>商品流向</el-breadcrumb-item>
      <el-breadcrumb-item>商品去处</el-breadcrumb-item>
    </el-breadcrumb>
    <!-- 右侧卡片区域 -->
    <!-- 用户列表卡片区 -->
  ...
  methods: {
      ...
      this.$refs.editRuleFormRef.validate(async valid => {
        if (!valid) {
          ...
          if (res.success) {
            ...
            this.$message.error("商品去处更新失败:" + res.data.errorMsg);
          }
    ...
    async edit(id) {
      ...
      if (res.success) {
        ...
        return this.$message.error("商品去处编辑失败" + res.data.errorMsg);
      }
      ...
      this.$refs.addRuleFormRef.validate(async valid => {
        if (!valid) {
          ...
          if (res.success) {
            ...
            return this.$message.error("商品去处添加失败:" + res.data.errorMsg);
          }
