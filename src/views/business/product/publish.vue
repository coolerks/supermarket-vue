<template>
    <div id="publishStocks">
        ...
        <el-breadcrumb separator="/" style="padding-left:10px;padding-bottom:10px;font-size:12px;">
            ...
            <el-breadcrumb-item>出库商品</el-breadcrumb-item>
        </el-breadcrumb>
        <!-- 卡片区域 -->
...
<!--                        出库步骤条-->
                        <el-steps style="margin-bottom: 20px;" :active="1" >
                            ...
                            <el-step title="出库" icon="el-icon-set-up"></el-step>
                        </el-steps>
<!--                        出库表单-->
                        ...
                        >
                            ...
                            <el-form-item v-if="existence==1" label="商品去向" prop="consumerId">
                            ...
                            <el-form-item label="期望时间" prop="type">
                                <el-radio-group v-model="addRuleForm.type">
                                    <el-radio  :size="'mini'" :label="0">立即</el-radio>
                                    <el-radio  :size="'mini'" :label="1">3h内</el-radio>
                                    <el-radio  :size="'mini'" :label="2">6h内</el-radio>
                                    <el-radio  :size="'mini'" :label="3">1天内</el-radio>
                                    <el-radio  :size="'mini'" :label="4">随时</el-radio>
                                </el-radio-group>
                            </el-form-item>
                            ...
                            <div v-if="existence==1">
                                <el-card class="box-card" style="margin-bottom: 30px;">
                                    <div  class="text item" style="font-size: 12px;padding: 5px;">
                                        商品名称: <span style="margin-left: 200px;color: #999">
                    <el-tag size="mini" type="info">{{consumerInfo.name}}</el-tag>
                  </span>
                                    </div>
                                    <div  class="text item" style="font-size: 12px;padding: 5px;">
                                        商品地址: <span style="margin-left: 200px;color: #999">
                                ...
                                <el-col :span="12">
                                    <div class="grid-content bg-purple">
                                        <el-form-item label="商品明细">
                                            <el-button size="mini"  icon="el-icon-search" @click="drawer = true">出库明细</el-button>
                                        </el-form-item>
                                    </div>
                                </el-col>
                                <el-col :span="12">
                                    <div class="grid-content bg-purple"><el-form-item label="商品总类">
            ...
            <el-col :span="13">
                <div class="grid-content bg-purple-light">
                    <el-card>
                        ...
                        <el-alert
                                title="勾选先下方商品后,在左侧表单的明细中添加其出库数量"
                                type="warning"
                        ...
                        <!-- 抽屉 -->
                        <el-drawer size="49%" title="出库明细" :visible.sync="drawer" :with-header="false">
              <span>
    ...
    export default {
        data() {
            ...
            return {
                ...
                addRules: {
                    consumerId: [
                        { required: true, message: "请选中商品去向", trigger: "blur" }
                    ],
                    type: [
                        { required: true, message: "请选中期望时间", trigger: "blur" }
                    ],
                    priority: [{ required: true, message: "请选中出库类型", trigger: "blur" }],
                    remark: [
        ...
        methods:{
            ...
            outStockNumberChange(currentValue, stock){
                if(currentValue===stock){
                    this.$message.warning("已达到可申请出库该商品数量的阈值");
                }
            },
            /**
             * 创建出库单
                    ...
                    if (!valid) {
                        ...
                        if (car.length > 0) {
                            ...
                            return this.$message.warning(
                                "出库商品的数量不能为空，请勾选商品后在明细中添加数量"
                            );
                        }
                        var res = await this.$confirm("此操作将提交出库单, 是否继续?", "提示", {
                        ...
                        if (res === "confirm") {
                            ...
                            if (res.success) {
                                this.$message.warning("商品出库进入审核状态");
                                await this.$router.push("/outStocks");
                            } else {
                                return this.$message.error("商品出库失败:" + res.data.errorMsg);
                            }
                        }
