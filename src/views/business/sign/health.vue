    ...
    <el-card style="height: 590px;">
      ...
      <h5 style="margin: 0px;padding: 0px;">基本信息
        <div style="float: right;margin-bottom: 10px;vertical-align: center;">
          ...
          <el-button style="margin-top: 5px;" type="primary" size="small" @click="onSubmit" v-if="!reported">立即汇报
          </el-button>
      ...
      <h5 style="margin: 0px;padding: 0px;">内容</h5>
      ...
      <el-form size="small" :inline="true" :label-position="'top'" :model="ruleForm" :rules="rules" ref="ruleFormRef"
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <div class="grid-content bg-purple">
              <el-form-item label="超市状况" prop="situation">
          ...
          <el-col :span="12">
            <div class="grid-content bg-purple">
              <el-form-item label="是否有送货人员到来" prop="touch">
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <div class="grid-content bg-purple">
              <el-form-item label="是否缺货" prop="passby">
          ...
          <el-col :span="12">
            <div class="grid-content bg-purple">
              <el-form-item label="卫生情况" prop="reception">
                <el-radio-group :disabled="reported" v-model="ruleForm.reception">
                  <el-radio :label="1">干净</el-radio>
                  <el-radio :label="0">脏乱</el-radio>
                </el-radio-group>
              </el-form-item>
            </div>
          </el-col>
