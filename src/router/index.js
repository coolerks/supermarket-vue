...

    {
        ...
        children: [
            ...
            , {
                ...
                name: 'ProductList',
                component: () => import( '../views/business/product/list.vue'), //商品列表
            }
            , {
                path: '/business/product/in-stocks',
                name: 'ProductInStocks',
                component: () => import( '../views/business/product/in-stock'), //商品入库记录
            },
            {
                path: '/business/product/out-stocks',
                name: 'ProductOutStocks',
                component: () => import( '../views/business/product/out-stock'), //商品出库记录
            }
            , {
                path: '/business/product/categories',
                name: 'ProductCategories',
                component: () => import( '../views/business/product/category'), //商品分类
            },
            {
            ...
            , {
                ...
                component: () => import( '../views/business/product/supplier'), //商品供应方
            },
            {
                path: '/business/product/consumers',
                name: 'ProductConsumers',
                component: () => import( '../views/business/product/consumer'), //商品消费方
            }
            , {
                path: '/business/product/add-stocks',
                name: 'ProductAddStocks',
                component: () => import( '../views/business/product/add-stock'), //商品入库
            },
            {
                path: '/business/product/publish',
                name: 'ProductPublish',
                component: () => import( '../views/business/product/publish'),   //商品出库
            },
            /**********************************监控模块的路由******************************/
            {
                path: '/monitor/logs',
